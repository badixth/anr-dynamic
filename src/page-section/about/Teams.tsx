...
export default function Teams() {
  return (
    <div className="bg-white dark:bg-[#070707] w-full px-[16px] md:px-[72px] py-[48px] md:py-[80px]">
      ...
      {/* Org Chart */}
      <div className="mt-[48px] md:mt-[64px] flex flex-col items-center max-w-[960px] mx-auto">
        {/* Tier 1: Board Advisor */}
        <div className="w-full max-w-[700px] bg-[#0D0D0D] dark:bg-[#111111] border border-white/[0.06] rounded-[20px] overflow-hidden group hover:border-[#F2B611]/[0.2] transition-colors duration-300">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-[24px] md:gap-[32px] p-[28px] md:p-[40px] relative">
            {/* Watermark */}
            <span className="absolute top-[16px] right-[24px] text-[80px] md:text-[120px] font-bold leading-none text-[#F2B611]/[0.04] select-none pointer-events-none font-heading">
              ANR
            </span>

            {/* Avatar */}
            <div className="relative flex-shrink-0">
              <div className="relative w-[120px] h-[120px] md:w-[140px] md:h-[140px] rounded-full overflow-hidden ring-[3px] ring-[#F2B611]/[0.3] ring-offset-[3px] ring-offset-[#0D0D0D] dark:ring-offset-[#111111]">
                <Image
                  src={director.image}
                  alt={director.name}
                  fill
            ...
            {/* Info */}
            <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left gap-[12px]">
        ...
        <div className="w-[2px] h-[16px] md:h-[40px] bg-gradient-to-b from-[#F2B611]/[0.4] to-[#F2B611]/[0.15]" />

        {/* Tier 2: Co-Founder & Director */}
        <div className="w-full max-w-[700px] bg-[#0D0D0D] dark:bg-[#111111] border border-white/[0.06] rounded-[20px] overflow-hidden group hover:border-[#F2B611]/[0.2] transition-colors duration-300">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-[24px] md:gap-[32px] p-[24px] md:p-[36px] relative">
            {/* Avatar */}
            <div className="relative flex-shrink-0">
              <div className="relative w-[100px] h-[100px] md:w-[120px] md:h-[120px] rounded-full overflow-hidden ring-[2px] ring-[#F2B611]/[0.3] ring-offset-[3px] ring-offset-[#0D0D0D] dark:ring-offset-[#111111]">
                <Image
                  src={coFounder.image}
                  alt={coFounder.name}
                  fill
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-[16px] md:gap-[20px]">
          {teamMembers.map((member, index) => (
            <div
              key={`team_${index}`}
              className="bg-[#0D0D0D] dark:bg-[#111111] border border-white/[0.06] rounded-[16px] overflow-hidden group hover:border-[#F2B611]/[0.2] transition-colors duration-300 p-[24px] md:p-[28px] flex flex-col items-center text-center gap-[16px] md:gap-[18px]"
            >
              {/* Avatar */}
              <div className="relative flex-shrink-0">
                <div className="relative w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-full overflow-hidden ring-[2px] ring-[#F2B611]/[0.3] ring-offset-[2px] ring-offset-[#0D0D0D] dark:ring-offset-[#111111] transition-all duration-300 group-hover:ring-[#F2B611]/[0.5]">
                  <Image
                    src={member.image}
                    alt={member.name}
                    fill
