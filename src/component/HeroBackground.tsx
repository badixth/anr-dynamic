  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute w-full bg-black pt-[25rem] -z-10">
        <div className="absolute right-[-30%] md:right-[-10%] bg-[#F2C911] blur-[60px] md:blur-[150px] w-[600px] md:w-[1710px] h-[500px] md:h-[1367px] rounded-[600px] md:rounded-[1710px]" />
        <div className="absolute mt-[-10%] md:mt-0 left-[-50%] md:left-[-25%] bg-[#F2B611] blur-[60px] md:blur-[180px] w-[600px] md:w-[1809px] h-[500px] md:h-[1444px] rounded-[600px] md:rounded-[1809px]" />
        <div className="ml-[-60%] md:ml-[-40%] lg:ml-[-32%] mt-[10%] md:mt-[7%] bg-[#fff] dark:bg-[#070707] blur-[50px] md:blur-[142px] w-[600px] md:w-[2774px] h-[500px] md:h-[1444px] rounded-[600px] md:rounded-[2774px]" />
      </div>
